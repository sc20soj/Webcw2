...
class YourTestClass(TestCase):
    ...
    def test_getUserDetails(self):
        ...
        response = requests.get('http://127.0.0.1:8000/getUserDetails', headers=self.transactionHeaders, data=data)
    ...
    def test_get_refundTransaction(self):
        ...
        response = requests.post('http://127.0.0.1:8000/refundTransaction', headers=self.transactionHeaders, data=data)
    ...
    def test_make_payment(self):
        ...
        response = requests.post('http://127.0.0.1:8000/makePayment', headers=self.transactionHeaders, data=data)
    ...
    def test_create_transaction(self):
        ...
        response = requests.post('http://127.0.0.1:8000/createTransaction/', headers=self.transactionHeaders, data=data)
    ...
    def test_get_transaction(self):
        ...
        response = requests.get('http://127.0.0.1:8000/getTransaction', headers=self.transactionHeaders, data=data)
    ...
    def test_get_user_transactions(self):
        data = '{"userId": "1"}'
        response = requests.get('http://127.0.0.1:8000/getUserTransactions', headers=self.transactionHeaders, data=data)
        #print("test_get_user_transactions ",response.text)
        self.assertTrue(response.status_code == 200)

    def test_get_email_transactions(self):
        data = '{"deliveryEmail": "sc20soj@leeds.ac.uk"}'
        response = requests.get('http://127.0.0.1:8000/getEmailTransactions', headers=self.transactionHeaders, data=data)
